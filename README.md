...
After install the themePack, please also install [themerec](https://marketplace.visualstudio.com/items?itemName=jtan.themerec), which is an extension that randomly recommend and install a theme from above theme list. 
